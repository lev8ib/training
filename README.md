...
| [Классификация токсичных комментариев](Classification_of_toxic_comments) | Используя данные, построить модель для классификации комментариев на позитивные и негативные| *pandas, numpy, sklearn, seaborn, matplotlib* |  Яндекс.Практикум  |
